...
<style>
  /* ==========================================================================
   INTERFAZ DE CONSULTA - TABLA DE MARCAS DE CELULARES (COMPACT DATA)
   ========================================================================== */
@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');

:root {
    --bg-main: #f8fafc;          /* Fondo gris claro de software ERP */
    --surface: #ffffff;          /* Fondo de la tabla */
    --text-primary: #0f172a;     /* Texto de datos */
    --text-secondary: #64748b;   /* Encabezados */
    --brand-color: #059669;      /* Verde Esmeralda corporativo para el módulo de marcas */
    --danger: #dc2626;           /* Rojo operativo para la acción eliminar */
...
body {
    ...
    min-height: 100vh;
    padding: 2.5rem 2rem;
    max-width: 800px; /* Ancho acotado para tablas de pocas columnas */
    margin: 0 auto;
}
...
/* Control estricto de proporciones para evitar deformaciones */
...
/* Zebra Striping e interactividad visual */
...
/* Contenedor del estado "Sin registros" */
p {
    background-color: var(--surface);
    color: var(--text-secondary);
    padding: 2rem;
...
body > a button:hover {
    background-color: #ecfdf5; /* Tinte sutil verde en hover */
    border-color: #a7f3d0;
    color: var(--brand-color);
...
.btn-delete-single:hover { background-color: var(--danger, #dc2626); color: #ffffff; border-color: var(--danger, #dc2626); }
    ...
    <div class="action-buttons">
        <a href="../vista/RegistrarMarca.php?idMarca=<?php echo $fila['id']; ?>" class="btn-edit">
            Editar
        </a>

        <a href="../controlador/GuardarEliminarMarcas.php?idMarca=<?php echo $fila['id']; ?>" 
