...
// 1. Recepción y limpieza de datos (forzamos ID a entero)
...
try {
    ...
    <div class='success-card'>
        ...
        <div class='success-text'>Marca " . ($id ? "actualizada" : "guardada") . " correctamente</div>
    ...
    <style>
        ...
        .error-title { color: #fee2e2; font-size: 1.5rem; font-weight: 700; margin-bottom: 15px; text-transform: uppercase; }
